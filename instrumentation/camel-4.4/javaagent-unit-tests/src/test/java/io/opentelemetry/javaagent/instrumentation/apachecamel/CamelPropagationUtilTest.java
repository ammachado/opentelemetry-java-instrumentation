...
import io.opentelemetry.javaagent.instrumentation.apachecamel.CamelPropagationUtil;
...
class CamelPropagationUtilTest {
  ...
  @Test
  void shouldExtractHttpParentForHttpEndpoint() {
  ...
  @Test
  void shouldNotFailExtractingNullHttpParentForHttpEndpoint() {
  ...
  void shouldNotFailExtractingNullAwsParentForSqsEndpoint() {
    ...
    // given
    Endpoint endpoint = new Sqs2Endpoint("", new Sqs2Component(), new Sqs2Configuration());
