...
import io.opentelemetry.javaagent.instrumentation.camel4.SpanDecorator;
...
public class DecoratorRegistry {
  ...
  private static Map<String, SpanDecorator> loadDecorators() {
    ...
    result.put("ahc", new GenericHttpSpanDecorator());
    ...
    result.put("http", new GenericHttpSpanDecorator());
    ...
    result.put("jetty", new GenericHttpSpanDecorator());
    ...
    result.put("netty-http4", new GenericHttpSpanDecorator());
    result.put("netty-http", new GenericHttpSpanDecorator());
    result.put("paho", new MessagingSpanDecorator("paho"));
    result.put("rabbitmq", new MessagingSpanDecorator("rabbitmq"));
    result.put("restlet", new GenericHttpSpanDecorator());
    result.put("rest", new RestSpanDecorator());
    result.put("seda", new InternalSpanDecorator());
    result.put("servlet", new GenericHttpSpanDecorator());
    ...
    result.put("undertow", new GenericHttpSpanDecorator());
