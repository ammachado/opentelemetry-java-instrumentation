  ...
  public static class StartAdvice {
    ...
    public static void onContextStart(@Advice.This CamelContext context) throws Exception {
      ...
      if (context.hasService(CamelTracingService.class) == null) {
        // start this service eager so we initialize before Camel is starting up
        CamelTracingService tracingService = new CamelTracingService(context);
        context.addService(tracingService, true, true);
        context.addRoutePolicyFactory(tracingService);
      }
    }
  }
}
