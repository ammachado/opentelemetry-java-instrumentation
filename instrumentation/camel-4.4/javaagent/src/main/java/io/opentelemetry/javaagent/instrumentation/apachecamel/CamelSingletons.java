...
final class CamelSingletons {

  private static final String INSTRUMENTATION_NAME = "io.opentelemetry.camel-4.4";
  ...
  static {
    ...
    INSTRUMENTER = builder.buildInstrumenter(CamelRequest::getSpanKind);
  }
